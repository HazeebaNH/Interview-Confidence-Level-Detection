...
# Load the model
model = load_model(r"/home/hazeeba/Documents/Luminar_internship/Interview_confidence_level/keras_model.h5", compile=False)

# Load the labels
class_names = open(r"/home/hazeeba/Documents/Luminar_internship/Interview_confidence_level/labels.txt", "r").readlines()
